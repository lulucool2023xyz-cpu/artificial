...
const faqs = [
    {
        question: "Apa perbedaan antara paket Free dan Pro?",
        answer: "Paket Free memiliki batasan 50 pesan/hari dan akses ke model dasar. Paket Pro memberikan unlimited pesan, akses ke semua model AI termasuk Gemini 2.5 Pro, dan fitur premium seperti Deep Thinking mode."
    },
    {
        question: "Bagaimana cara upgrade ke Pro?",
        answer: "Klik tombol 'Upgrade ke Pro', pilih periode pembayaran (bulanan atau tahunan), lalu selesaikan pembayaran melalui metode yang tersedia."
    },
    {
        question: "Apakah bisa membatalkan subscription kapan saja?",
        answer: "Ya, Anda bisa membatalkan subscription kapan saja tanpa biaya tambahan. Akses Pro tetap aktif hingga akhir periode yang sudah dibayar."
    },
    {
...
const Pricing = memo(function Pricing() {
    ...
    const handleSubscribe = (planId: string) => {
        ...
        navigate(`/chat/subscription?plan=${planId}&billing=${billingCycle}`);
    };

    const handleAuthSuccess = () => {
        setIsAuthModalOpen(false);
        if (pendingPlan) {
            navigate(`/chat/subscription?plan=${pendingPlan}&billing=${billingCycle}`);
            setPendingPlan(null);
        }
    };
            ...
            <main className="flex-1 pt-20">
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#FFD700]/10 border border-[#FFD700]/20 mb-6">
                            ...
                            <span className="text-sm text-[#FFD700] font-medium">Pilih Paket Terbaik</span>
                        </div>
                        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4">
                            Harga <span className="text-[#FFD700]">Transparan</span>, Tanpa Biaya Tersembunyi
                        </h1>
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h3 className="text-xl font-bold text-foreground mb-4">Ada Pertanyaan Lain?</h3>
                        <p className="text-muted-foreground mb-6">
                            Hubungi tim kami untuk informasi lebih lanjut tentang paket Enterprise
                        </p>
                        <button
                            onClick={() => navigate('/resources/support')}
                            className="px-6 py-3 rounded-xl border border-[#FFD700] text-[#FFD700] font-semibold hover:bg-[#FFD700]/10 transition-colors"
                        >
                            Hubungi Kami
                        </button>
                    </motion.div>

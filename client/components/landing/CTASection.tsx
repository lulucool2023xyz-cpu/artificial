  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        {/* Primary CTA Button - using CSS classes instead of inline handlers */}
        <ScrollReveal delay={0.3} duration={0.7} distance={25}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <button
              onClick={onGetStartedClick}
              className="group px-10 sm:px-14 py-4 sm:py-5 bg-white text-black font-bold font-heading text-base sm:text-lg rounded-lg cursor-pointer button-batik-hover focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-black text-center transition-all duration-300 hover:scale-[1.03] active:scale-[0.98]"
            ...
            <a
              ...
              download="Orenax.apk"
              className={cn(
                "inline-flex items-center justify-center gap-3 px-10 sm:px-14 py-4 sm:py-5 border-2 font-bold font-heading text-base sm:text-lg rounded-lg hover-glow button-batik-hover focus:outline-none focus:ring-2 focus:ring-offset-2 text-center transition-all duration-300 hover:scale-[1.03] active:scale-[0.98]",
                theme === 'dark'
          ...
          <OrnamentFrame variant="jawa" className="bg-gradient-to-br from-white/10 to-white/5 border border-indonesian-gold/20 rounded-2xl p-6 sm:p-10 backdrop-blur-sm" style={{
            ...
            <div className="text-center pt-4 border-t border-indonesian-gold/20">
              <button
                ...
                className="px-8 py-3 bg-indonesian-gold text-black font-bold font-heading rounded-lg transition-all duration-300 hover:bg-indonesian-gold/90 focus:outline-none focus:ring-2 focus:ring-indonesian-gold focus:ring-offset-2 focus:ring-offset-black"

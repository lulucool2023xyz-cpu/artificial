    ...
    return (
        ...
        >
            <div className="text-center py-16 px-4">
                <h2 className="text-3xl md:text-5xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-[#FFD700] to-[#D97706]">
                    {title}
                </h2>
                        ...
                        <>
                            ...
                            <motion.div
                                ...
                                style={{
                                    ...
                                    background: `linear-gradient(to bottom, #FFD700, #D97706, #C2410C)`,
                                    boxShadow: `
                  ...
                  `,
                            ...
                            >
                                <motion.div
                                    ...
                                    style={{
                                        background:
                                            "radial-gradient(circle, rgba(255,215,0,0.8) 0%, rgba(217,119,6,0.5) 40%, rgba(194,65,12,0) 70%)",
                                        boxShadow: `
                      0 0 15px 4px rgba(255, 215, 0, 0.6),
                      0 0 25px 8px rgba(217, 119, 6, 0.4),
                      0 0 40px 15px rgba(194, 65, 12, 0.2)
                    `,
                                    }}
                                    animate={{
                                        scale: [1, 1.3, 1],
                        ...
                        {events.map((event, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        <Card className="bg-background border border-[#FFD700]/20 hover:border-[#FFD700]/40 transition-all">
                                            <CardContent className="p-6">
                                                {dateFormat === "badge" ? (
                                                    ...
                                                    <p className="text-lg font-bold text-[#FFD700] mb-2">
                                                        {event.year}
                                                    </p>
                                                )}

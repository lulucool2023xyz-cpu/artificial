                ...
                {studio === "image" && (
                    <div className="flex-1 flex flex-col min-h-0">
                        ...
                        <div className="flex-1 flex flex-col min-h-0 relative">
                            {/* Canvas - Theme aware */}
                            <div className="flex-1 bg-secondary/20 dark:bg-[#0A0A0A] flex items-center justify-center overflow-auto p-4">
                                {isGenerating ? (
